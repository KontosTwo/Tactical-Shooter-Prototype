...
{
	public void shoot(double y1,double x1,double height1,double y2,double x2,double z2,SoldierBattle h,double accuracy);
	...
	public boolean hitMarkerNear(SoldierBattle h); // checks if any shots landed near this humanoid
	public void scanBattleField(SoldierBattle h); // alows the humanoid to look around the battle field and react to other entities
